...
if GOOD:
    ...
    D = w_0 * (
    1 - ((math.pow(P[1][1] - P[0][1], N + 1)) * (1 - P[1][1])) / (1 - math.pow(P[1][1], 2) + P[1][1] * P[0][1]))
    ...
    F = (1 - P[0][1]) * (1 - w_0) * (1 / (2 - P[0][1]) - (P[0][1] * math.pow(P[1][1] - P[0][1], 4)) / (
    1 - math.pow(P[1][1] - P[0][1], 2) * math.pow(1 - P[0][1], 2)))

    E = p_temp * (1 + P[0][1]) + P[0][1] * (1 - F)

    G = (1 - w_0) * (1 / (2 - P[0][1]) - P[0][1] * math.pow(P[1][1] - P[0][1], 6) / (
    1 - math.pow(P[1][1] - P[0][1], 2) * math.pow(1 - P[0][1], 2)))

    H = (1 - w_0) * (1 / (2 - P[0][1]) - P[0][1] * math.pow(P[1][1] - P[0][1], 2 * N - 1) / (
    1 - math.pow(P[1][1] - P[0][1], 2) * math.pow(1 - P[0][1], 2)))
