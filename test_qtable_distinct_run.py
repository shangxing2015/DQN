...
for i in range(10):
    ...
    finalResult = 'final_result_5_channel_same_Aug_2' + str(i)
    ...
    for j in range(10):
        ...
        file_whittle = 'log_whittle_cvg_5_same_Aug_2' + str(i) + '_' + str(j)
        file_qtable = 'log_q_table_cvg_5_same_Aug_2' + str(i) + '_' + str(j)
